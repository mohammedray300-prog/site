...
import charcoalBlackExample from "@/assets/charcoal-black-example.jpg";
import blueFilmExample from "@/assets/blue-film-example.jpg";
import dualReflective from "@/assets/dual-reflective.jpg";
import dualReflectiveExample from "@/assets/dual-reflective-example.jpg";
...
import recentHouseDoor from "@/assets/recent-house-door.jpg";
import recentHouseBlackDoor from "@/assets/recent-house-black-door.jpg";
import recentHouseTerrace from "@/assets/recent-house-terrace.jpg";
import recentConservatoryWhite from "@/assets/recent-conservatory-white.jpg";
import recentConservatoryMahogany from "@/assets/recent-conservatory-mahogany.jpg";
import recentAudiTint from "@/assets/recent-audi-tint.jpg";
import recentGolfTint from "@/assets/recent-golf-tint.jpg";
import recentHouseLoft from "@/assets/recent-house-loft.jpg";
import myCarGolf from "@/assets/my-car-golf.jpg";
      ...
      <div className="mx-auto max-w-[1400px] px-6 sm:px-10 grid lg:grid-cols-12 gap-14 items-start">
        <div className="reveal lg:col-span-5">
          <figure className="relative overflow-hidden rounded-3xl aspect-[4/5] shadow-lift">
            <img src={myCarGolf} alt="Precision installation" className="h-full w-full object-cover" />
          </figure>
        </div>
...
function Gallery() {
  ...
  const [lightbox, setLightbox] = useState<string | null>(null);
  const set = {
    all:  [recentHouseDoor, recentHouseBlackDoor, recentAudiTint, recentHouseTerrace, recentConservatoryWhite, recentGolfTint, myCarGolf, recentHouseLoft, recentConservatoryMahogany, charcoalFilm, heroCar, blueFilmExample, blackTint, dualReflective, chameleonBlue, heroHome, blackTint],
    res:  [recentHouseDoor, recentHouseBlackDoor, recentHouseTerrace, recentHouseLoft, recentConservatoryWhite, recentConservatoryMahogany, charcoalFilm, blueFilmExample, dualReflective, heroHome, charcoalFilm, blueFilmExample],
    auto: [recentAudiTint, recentGolfTint, myCarGolf, heroCar, blackTint, chameleonBlue, blackTint, heroCar, chameleonBlue],
  }[tab];
  const shapes = [
